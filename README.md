...
3. **(Optional) Configure Ingress**:

   If using an ingress controller, create an ingress resource:
...
- **Via Ingress**: If using ingress, ensure that your domain is correctly configured to point to your ingress controller. Access the application via `http://your-domain.com`.
